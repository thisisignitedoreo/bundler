/* Wedge asset bundler implementation. */
...
const char *generate_name(const char *next_name, const char *arg) {
    const char *origin = basename(arg);
...
int main(int argc, char **argv) {
    ...
    while (argc) {
        ...
        if (strcmp(arg, "-o") == 0) {
            ...
            memcpy(files[files_bundled++], name, strlen(name) + 1);
            next_name = NULL;
    ...
    fprintf(sink, "\n/*\n * This file was auto-generated by Wedge bundler.\n * Files bundled: ");
